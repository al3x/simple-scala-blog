...
My full name is Alexander Francis Payne. I go by Alex. I've used the handle "al3x" for over ten years around the Internet, and I'm perhaps better recognized by it. At the time of writing (Nov 29, 2008) I'm twenty-five, and I've lived in San Francisco's SoMA (South of Market) neighborhood since mid-2007. I grew up around Washington, DC.
...
In terms of social ideology, I identify as a secular humanist. I'm an agnostic. Politically, I'm a registered independent; my politics are closest to that of "The Economist": mildly Libertarian, fiscally conservative, socially liberal where it's practical and pragmatic, cautiously globalist.
...
I currently use a custom blogging system written in "Scala":http://scala-lang.org that translates a directory structure of Textile-formatted files organized by year, month, and day into a corresponding directory structure of HTML files. I then sync the directory of HTML files to my server via Rsync over SSH. This system allows me to write posts in my favorite text editor, "TextMate":http://macromates.com, and allows me complete control over the design and structure of my site while remaining portable and inexpensive to host.

"al3x.net":http://al3x.net is registered at and hosted by "Gandi":http://gandi.net, a superb French registrar with a very competitive Virtual Private Server offering. My VPS runs a recent release of Ubuntu GNU/Linux and little more than the Nginx web server. I outsource email and Jabber instant messaging hosting to "Google Apps":http://google.com/a.
...
* "Last.fm":http://last.fm/users/al3x -- the music I listen to.
