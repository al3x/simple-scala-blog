...
widget, or if Dashboard just likes the taste of %(=caps)CPU% in the morning.
...
on a machine with 1.5GB of %(=caps)RAM% – Dashboard claims half of what’s available when invoked. It
