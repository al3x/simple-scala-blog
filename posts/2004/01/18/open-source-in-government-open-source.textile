...
--- 
- p. A couple items caught my eyes in the ol’ tech/government vein.
...
The second is a Linux Journal "report":http://linuxjournal.com/article.php?sid=7131 on the increasing presence of the %(=caps)LAMP% (Linux + Apache + MySQL + %(=caps)PHP%/Perl/Python) platform powering government websites and online resources.  It’s mostly the doing of shops that G-men contract out to, but it’s still a Good Thing.
