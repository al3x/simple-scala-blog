...
I’ve been over this bullshit before.  Computer musicians want a portable %(=caps)USB% or FireWire %(=caps)MIDI% unit that provides a keyboard, some assignable controllers, and a multichannel audio interface.  Most computer musicians need multiple outputs, and they need a dedicated headphone output for pre-listening, a feature essential to digital DJ applications and live performance software like Ableton Live.

Nobody has yet built a device that does this, despite the components being readily available and no engineering barriers hindering such a product’s development.  M-Audio came close with their Ozone, and it seemed on spec like Edirol got it right with their "%(=caps)PCR%-1":edirol.com/products/info/pcr1.html.

But Edirol fucked it up.  I just got this email from their sales department:

  Hi there,
  The headphone output mirrors the %(=caps)RCA% output on the %(=caps)PCR%-1.
  Kindly,
  Chris Douglass
  %(=caps)LEAD PRODUCT SPECIALIST%
  360.594.4273X213 phone
  360.594.4271 fax

That means that the headphone output is exactly the same as the %(=caps)RCA% output.  It carries the same signal.  Other than having a different plug, it is wholly superfluous.  That makes the %(=caps)PCR%-1 all but worthless to me and many other computer musicians.
