...
I'm so taken with Nginx that I decided to keep it as my public-facing %(=caps)HTTP% server.  I just run an Apache virtual host for Subversion on a high port and and tell Nginx to proxy to it like so:
