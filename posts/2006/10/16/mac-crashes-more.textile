...
I’ve gone back to using a “Life” project in "TextMate":http://www.macromates.com for short-term notes, numbers, ideas, and so forth.  Not having to worry (read: not being able to worry) about styling text, quirky list behavior, and other %(=caps)RTF% oddities is a burden lifted.  "Witch":http://www.petermaurer.de/nasi.php?section=witch makes getting to that project that much easier and "Megazoomer":http://www.ianhenderson.org/megazoomer.html lets me focus on TextMate and only TextMate.
